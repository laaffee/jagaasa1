                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select-category @error('role_id') is-invalid @enderror" name="role_id">
                            ...
                            <div class="form-group">
                                <label>Donatur</label><span style="color:red;font-weight:bold"> * </span>
                                <select class="form-control select-category @error('role_id') is-invalid @enderror" name="donatur_id">
                                    <option value="">-- Pilih Donatur --</option>
                                    @foreach ($donatur as $d)
                                        <option value="{{ $d->id }}" {{ old('donatur_id') == $d->id ? 'selected' : '' }}>{{ $d->nama }}</option>
                                    @endforeach
                                </select>
                                @error('role_id')
                                <div class="invalid-feedback" style="display: block">
