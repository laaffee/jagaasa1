                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.video.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_video" value="{{ old('tgl_video') }}" class="form-control @error('tgl_video') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="keterangan" value="{{ old('keterangan') }}" placeholder="Masukkan Keterangan Video" class="form-control @error('keterangan') is-invalid @enderror">
