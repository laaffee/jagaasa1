        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <a href="{{ route('admin.kategori.create') }}" class="btn btn-primary mb-3" title="Tambah Data"><i class="fa fa-plus"></i> Tambah {{ $title }}</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tabelKategori">
                            ...
                            <tbody>
                                @foreach ($data as $no => $ktg)
                                <tr>
                                    <th scope="row" style="text-align: center">{{ ++$no }}.</th>
                                    <td>{{ $ktg->nama }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.kategori.edit', $ktg->id) }}" class="btn btn-sm btn-primary">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $ktg->id }}">
